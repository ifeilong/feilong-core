...
public final class RegexPattern{
    ...
    public static String IP                = "^(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)\\.(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)\\.(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)\\.(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)$";

    /** 电话号码 <code>{@value}</code>. */
    public static String TELEPHONE         = "^(\\d{3,4}-)?\\d{6,8}$";
     ...
     */
    public static String MOBILEPHONE       = "^((13[0-9])|(15[^4,\\D])|(17[0-9])|(18[0-9]))\\d{8}$";

    //******************************************************************************

    /** 网址Url 链接 <code>{@value}</code>. */
    public static String URLLINK           = "http(s)?://([\\w-]+\\.)+[\\w-]+(/[\\w- ./?%&=]*)?";
    ...
    public static String LETTER_LOWERCASE  = "^[a-z]+$";

    /** 大写字母 <code>{@value}</code>. */
    public static String LETTER_UPPERCASE  = "^[A-Z]+$";
     ...
     * </pre>
     */
    public static String DECIMAL_TWO_DIGIT = "^[0-9]+(.[0-9]{2})?$";
    ...
    public static String AN                = "^[0-9a-zA-Z]+$";

    /** 字母和数字和空格(alpha numeric space)<code>{@value}</code>. */
    public static String ANS               = "^[0-9a-zA-Z ]+$";
